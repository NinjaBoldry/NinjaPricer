...
- `DepartmentBillRate` — department*id, bill_rate_per_hour (admin-set). Department surface also shows the \_computed* avg loaded rate (blended from active employees with burdens applied).
