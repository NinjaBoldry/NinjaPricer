...
const SCOPE_LABELS: Record<string, string> = {
  ALL: 'All', PRODUCT: 'Product', DEPARTMENT: 'Department',
};
const METRIC_LABELS: Record<string, string> = {
  REVENUE: 'Total Revenue', CONTRIBUTION_MARGIN: 'Contribution Margin',
  TAB_REVENUE: 'Tab Revenue', TAB_MARGIN: 'Tab Margin',
};
  ...
  return (
    <div className="p-6">
      <div className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
        ...
        <span>/</span>
        <Link href="/admin/commissions" className="hover:underline">Commission Rules</Link>
        <span>/</span>
      ...
      <div className="flex items-center gap-3 mb-2">
        ...
        <span className="text-xs text-muted-foreground border rounded px-2 py-0.5">{SCOPE_LABELS[rule.scopeType]}</span>
        <span className="text-xs text-muted-foreground border rounded px-2 py-0.5">{METRIC_LABELS[rule.baseMetric]}</span>
      </div>
      ...
      {rule.tiers.length === 0 && (
        <p className="text-sm text-destructive mb-4 font-medium">
          Warning: This rule has no tiers and will be skipped during commission calculation.
          Add a tier starting at threshold $0.
        </p>
      )}
        ...
        <section className="max-w-sm">
          ...
          <form action={addTierAction} className="space-y-4">
            <div className="space-y-1">
              ...
              <Input
                id="thresholdFromUsd" name="thresholdFromUsd" type="number"
            ...
            <div className="space-y-1">
              ...
              <Input
                id="ratePct" name="ratePct" type="number"
                step="0.01" min="0" max="100" required placeholder="10"
              />
            </div>
            <div className="space-y-1">
